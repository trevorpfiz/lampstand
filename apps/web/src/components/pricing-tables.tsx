            ...
            <span className="-top-10 -end-4 md:-end-10 absolute start-auto">
              <span className="flex items-center">
                <svg
                  ...
                  role="img"
                  aria-label="Curved arrow pointing to annual pricing"
                >
                  <title>Curved arrow pointing to annual pricing</title>
                  <path
                ...
                <Badge className="mt-3 bg-blue-500">Save 10%</Badge>
              </span>
            </span>
          </TabsTrigger>
        </TabsList>
          ...
          <Card key={plan.name} className="flex flex-col">
            ...
            <CardContent className="flex flex-1 flex-col">
              <Button
                ...
                asChild
              >
                <Link href={`${appUrl}`}>{plan.buttonText}</Link>
              </Button>
