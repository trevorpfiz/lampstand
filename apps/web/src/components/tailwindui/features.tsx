          ...
          <div className="relative lg:row-span-2">
            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] lg:rounded-l-[calc(2rem+1px)]">
              ...
              <div className="relative min-h-[30rem] w-full grow [container-type:inline-size] max-lg:mx-auto max-lg:max-w-sm">
                <div className="absolute inset-x-10 top-10 bottom-0 overflow-hidden rounded-t-[12cqw] border-muted border-x-[3cqw] border-t-[3cqw] bg-muted shadow-2xl">
                  <img
          ...
          <div className="relative lg:row-span-2">
            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] max-lg:rounded-b-[calc(2rem+1px)] lg:rounded-r-[calc(2rem+1px)]">
              ...
              <div className="relative min-h-[30rem] w-full grow">
                <div className="absolute top-10 right-0 bottom-0 left-10 overflow-hidden rounded-tl-xl bg-muted shadow-2xl">
                  <div className="flex bg-muted/40 ring-1 ring-border">
                    <div className="-mb-px flex font-medium text-muted-foreground text-sm/6">
                      <div className="border-r border-r-border/10 border-b border-b-border/20 bg-border/5 px-4 py-2 text-foreground">
                        NotificationSetting.jsx
                      </div>
                      <div className="border-border/10 border-r px-4 py-2">
                        App.jsx
                      </div>
                    </div>
                  </div>
                  <div className="px-6 pt-6 pb-14">test</div>
                </div>
              </div>
            </div>
