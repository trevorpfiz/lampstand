                ...
                <TabsList className="h-auto gap-0 rounded-none border-none bg-transparent py-0 pr-0.5 pl-0 text-foreground">
                  {initialChats?.map((chat) => (
                    <TabsTrigger
                      ...
                      value={chat.id}
                      className={cn(
                        'relative min-w-20 max-w-40 flex-shrink-0 rounded-none border-border border-r bg-muted transition-none hover:bg-background hover:text-foreground data-[state=active]:bg-background data-[state=active]:shadow-none data-[state=active]:hover:bg-background',
